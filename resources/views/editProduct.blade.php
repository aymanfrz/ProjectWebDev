...
<head>
    ...
    <title>Edit Product - KayaBoys</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('createproduct.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="category" name="category">
                    <option value="sweet" {{ old('category', $product->category) == 'sweet' ? 'selected' : '' }}>Sweet</option>
                    <option value="savory" {{ old('category', $product->category) == 'savory' ? 'selected' : '' }}>Savory</option>
                </select>
